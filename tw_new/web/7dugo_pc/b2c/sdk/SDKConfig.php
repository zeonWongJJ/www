...
class SDKConfig {
	...
	function __construct(){
		...
		$this->signCertPath = '/data/www/tw/web/7dugo_pc/b2c/key_private.pfx';
		$this->signCertPwd = '7du666';
		
		$this->validateCertDir = array_key_exists("acpsdk.validateCert.dir", $sdk_array)? $sdk_array["acpsdk.validateCert.dir"]: null;
		$this->encryptCertPath = '/data/www/tw/web/7dugo_pc/b2c/acp_prod_enc.cer';
		$this->rootCertPath = '/data/www/tw/web/7dugo_pc/b2c/acp_prod_root.cer';
		$this->middleCertPath = '/data/www/tw/web/7dugo_pc/b2c/acp_prod_middle.cer';
