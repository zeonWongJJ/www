$(function(){
    ...
    $(".remark>img").click(function(e){
        $(this).next($("#disappare")).stop().show(100).delay(3000).hide(100);
    });
    // doProgress(700);

    $(".transactionState>div>a").click(function(){
          $(".shareOrders").show();
    });
    $(".closeLay").live("click",function(){
        $(".shareOrders").hide();
    });
...
//     if (progress) {
//         $(".progressContent").css("width", ((String(progress))/1000)*100+"%"); //控制#loading div宽度
//     }
// }
// var i = 0;
