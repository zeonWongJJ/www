...
ini_set('session.gc_maxlifetime', 30*24*3600); // 秒 
ini_set("session.cookie_lifetime",30*24*3600); // 秒  
...
// 项目路径
define('PROJECTPATH', APPPATH . '/vdao_cashier');
// 控制器路径
define('CONTPATH', PROJECTPATH . '/controller');
// 模型路径(为了多项目模型共享)
define('MODELPATH', PROJECTPATH . '/model');
// 模板路径
define('TEMPATH', PROJECTPATH . '/template/default');
// 系统核心类前缀，不可修改
define('TW_', 'TW_');
