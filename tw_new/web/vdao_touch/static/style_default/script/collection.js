 ...
 */
$(function(){
    var storeHeadCheck=$(".storeList>dl>dt>a>img");//门店
    var storeChildCheck=$(".storeList>dl>dd>img");
    var productHeadCheck=$(".productList>dl>dt>a>img");//产品
    var productChildCheck=$(".productList>dl>dd>img");
    var officeHeadCheck=$(".officeList>dl>dt>a>img");//办公室
    var officeChildCheck=$(".officeList>dl>dd>img");

    storeHeadCheck.css("display","none");
    storeChildCheck.css("display","none");
    productHeadCheck.css("display","none");
    productChildCheck.css("display","none");
    officeHeadCheck.css("display","none");
