...
<div class="lrp">
        ...
        <div class="login">
            <form action="<?php echo $this->router->url('login'); ?>" method="post">
                <div class="user">
                    ...
                    <input type="text" id="user" name="tel_or_username" placeholder="手机号/用户名"/>
                </div>
                <div class="pwd">
    ...
    <div id="register" class="register ">
        ...
        <!-- 注册背景 -->
        <form id="registerForm" action="<?php echo $this->router->url('register'); ?>" method="post">
            <div class="userPhone" >
            ...
            <div class="userCode">
                <div class="codeBox">
                    ...
                    <div class="codeContent">
                        <a class="getCode" >
                            <i>
                                <span class="" onclick="get_code(1)">获取验证码</span>
                                <s class="hide" style="text-decoration:none;">2s</s>
                                <em class="hide" onclick="get_code(1)">重新获取</em>
