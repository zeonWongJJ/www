					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="post"  name="add_goods" role="form" enctype="multipart/form-data">

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商品名称 </label>
										<div class="col-sm-9">
											<input type="text" required="required" name="goods_name" id="form-field-1" value="<?php echo $a_view_data['goods']['goods_name'] ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商品广告词 </label>
										<div class="col-sm-9">
											<input type="text" required="required" name="goods_jingle" id="form-field-1" value="<?php echo $a_view_data['goods']['goods_jingle'] ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" required="required" name="keywords" id="form-field-1" value="<?php echo $a_view_data['goods']['keywords'] ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select"  name="store_id" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="brand_id" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group form-g">
										...
										<div class="col-sm-9">
											<select class="gc_id_1" name="gc_id_1" >
											...
											<select class="gc_id_2" name="gc_id_2" id="area_city">
												<option value="">--请选择--</option>
											...
											<select class="gc_id_3" name="gc_id_3" id="area_town">
												<option value="">--请选择--</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="areaid_1" name="areaid_1" id="areaid_1" >
											...
											<select class="areaid_2" name="areaid_2" id="areaid_2" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="transport_id" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="goods_price" required="required" min="0" id="form-field-1" placeholder="商品价格" value="<?php echo $a_view_data['goods']['goods_price'] ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="goods_marketprice" required="required" min="0" id="form-field-1" placeholder="市场价" value="<?php echo $a_view_data['goods']['goods_marketprice'] ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="goods_promotion_type" id="form-field-select-3" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="goods_promotion_price" id="form-field-1" value="<?php echo $a_view_data['goods']['goods_promotion_price'] ?>"  placeholder="商品促销价格" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="goods_discount" id="form-field-1" placeholder="商品折扣价格" value="<?php echo $a_view_data['goods']['goods_discount'] ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" value="<?php echo $a_view_data['goods']['goods_storage_alarm'] ?>" name="goods_storage_alarm" id="form-field-1" placeholder="库存报警值" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" min="0" required="required" name="goods_click" id="form-field-1" value="<?php echo $a_view_data['goods']['goods_click'] ?>" placeholder="商品点击数量" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" min="0" required="required" name="goods_salenum" id="form-field-1" value="<?php echo $a_view_data['goods']['goods_salenum'] ?>" placeholder="销售数量" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" value="<?php echo $a_view_data['goods']['goods_collect'] ?>" required="required" min="0" name="goods_collect" id="form-field-1" placeholder="收藏数量" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" min="0" value="<?php echo $a_view_data['goods']['goods_storage'] ?>" required="required" name="goods_storage" id="form-field-1" placeholder="商品库存" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" value="<?php echo $a_view_data['goods']['deductible_point'] ?>" required="required" min="0" name="deductible_point" id="form-field-1" placeholder="每个商品能使用的积分" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" min="0" required="required" name="goods_feng" id="form-field-1" value="<?php echo $a_view_data['goods']['goods_feng'] ?>" placeholder="指定产品的赠送积分数" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="file"  name="goods_image" id="form-field-1" placeholder="商品主图" class="col-xs-10 col-sm-5" />
											<img style="width: 200px;height: 200px;" src="<?php echo get_config_item('img_path')  . $a_view_data['goods']['store_id'] . '/' . $a_view_data['goods']['goods_image'] ?>" alt="">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="payment" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="type_id" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="evaluation_count" value="<?php echo $a_view_data['goods']['evaluation_count'] ?>" id="form-field-1" placeholder="评价数" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" name="evaluation_good_star" value="<?php echo $a_view_data['goods']['evaluation_good_star'] ?>" id="form-field-1" max="5" min="0" placeholder="好评星级" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="goods_state" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="goods_verify" id="form-field-select-3" data-placeholder="Choose a Country...">
												<option value="">--请选择商品审核--</option>
												<option <?php select($a_view_data['goods']['goods_verify'],0) ?> value="0">未通过</option>
												<option <?php select($a_view_data['goods']['goods_verify'],1) ?> value="1">通过</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="goods_lock" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="goods_commend" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="is_virtual" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="virtual_indate" value="<?php echo $a_view_data['goods']['virtual_indate'] ?>" id="form-field-1" placeholder="虚拟商品有效期" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="virtual_limit" value="<?php echo $a_view_data['goods']['virtual_limit'] ?>" id="form-field-1" placeholder="虚拟商品购买上限" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="virtual_invalid_refund" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="is_fcode" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="is_appoint" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="is_presell" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="have_gift" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="is_own_shop" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea style="width:370px;height: 100px;" name="description" required="required"><?php echo $a_view_data['goods']['description'] ?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9" style="height:800px">
											<textarea id="editor" name="goods_body"><?php echo $a_view_data['goods']['goods_body'] ?></textarea>
										</div>
									</div>
						           
									<div class="space-4"></div>

									<div class="clearfix form-actions" style="float: left">
										<div class="col-md-offset-3 col-md-9" style="float: left;margin-left:0;min-width: 251px">
											<button class="btn btn-info" type="botton" onclick ="return false">
