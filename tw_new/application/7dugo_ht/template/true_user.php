						...
						<div class="row">
							...
							<div class="col-xs-12">
								<?php foreach ($a_view_data as $key => $value): ?>
									...
									<div class="form-group">
										<label> 用户性别 ：</label>
											<?php echo $value['member_sex']?>
									</div>
									<div class="form-group">
										<label> 用户生日 ：</label>
											<?php echo $value['member_birthday']?>
									</div>
									<div class="form-group">
										<label> 用户邮箱 ：</label>
									...
									<div class="form-group">
										<label> 用户QQ ：</label>
											<?php echo $value['member_qq']?>
									</div>
									<div class="form-group">
										<label> 用户阿里旺旺 ：</label>
											<?php echo $value['member_ww']?>
									</div>
									<div class="form-group">
										<label> 用户登录次数 ：</label>
											<?php echo $value['member_login_num']?>
									</div>
									<div class="form-group">
										<label> 用户注册时间 ：</label>
											<?php echo date("Y-m-d",  $value['member_time']);?>
									</div>
									<div class="form-group">
										<label> 用户登录时间 ：</label>
									...
									<div class="form-group">
										<label> 用户上次登录时间 ：</label>
											<?php echo date("Y-m-d",  $value['member_time_old_login']);?>
									</div>
									<div class="form-group">
										<label> 用户登录IP ：</label>
											<?php echo $value['member_login_ip']?>
									</div>
									<div class="form-group">
										<label> 用户上次登录IP ：</label>
											<?php echo $value['member_old_login_ip']?>
									</div>
									<div class="form-group">
										<label> 用户积分 ：</label>
									...
									<div class="form-group">
										<label> 用户余额 ：</label>
											<?php echo $value['available_predeposit']?>
									</div>
									<div class="form-group">
										<label> 用户冻结余额 ：</label>
											<?php echo $value['freeze_predeposit']?>
									</div>
									<div class="form-group">
										<label> 用户充值卡余额 ：</label>
											<?php echo $value['available_rc_balance']?>
									</div>
									<div class="form-group">
										<label> 用户冻结充值卡余额 ：</label>
											<?php echo $value['freeze_rc_balance']?>
									</div>
									<div class="form-group">
										<label> 是否允许举报 ：</label>
											<?php if ($value['inform_allow'] == 1) {?>
												可以
											<?php } else { ?>
												不可以
											<?php }?>
									...
									<div class="form-group">
										<label> 是否有咨询和发送站内信的权限 ：</label>
											<?php if ($value['is_allowtalk'] == 1) {?>
												有
											<?php } else { ?>
												无
											<?php }?>
									...
									<div class="form-group">
										<label> 地区ID ：</label>
											<?php echo $value['member_areaid']?>
									</div>
									<div class="form-group">
										<label> 城市ID ：</label>
											<?php echo $value['member_cityid']?>
									</div>
									<div class="form-group">
										<label> 省份ID ：</label>
											<?php echo $value['member_provinceid']?>
									</div>
									<div class="form-group">
										<label> 地区内容 ：</label>
											<?php echo $value['member_areainfo']?>
									</div>
									<div class="form-group">
										<label> 用户经验值 ：</label>
											<?php echo $value['member_exppoints']?>
									</div>
								<?php endforeach ?> 
							</div>
