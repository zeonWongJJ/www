							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="post"  name="add_goods" role="form" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" required="required" name="goods_name" id="form-field-1" placeholder="商品名称" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商品广告词 </label>
										<div class="col-sm-9">
											<input type="text" required="required" name="goods_jingle" id="form-field-1" placeholder="商品广告词" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" required="required" name="keywords" id="form-field-1" placeholder="商品关键词" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select"  name="store_id" id="form-field-select-3" data-placeholder="Choose a Country...">
												...
												<option data="<?php echo $value['store_name'] ?>" value="<?php echo $value['store_id'] ?>"><?php echo $value['store_name'] ?></option>
												<?php endforeach ?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="brand_id" id="form-field-select-3" data-placeholder="Choose a Country...">
												...
												<?php foreach ($a_view_data['brand'] as $key => $value): ?>
									...
									<div class="form-group form-g">
										...
										<div class="col-sm-9">
											<select class="gc_id_1" name="gc_id_1" >
												...
												<?php foreach ($a_view_data['gc_id_1'] as $key => $value): ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="transport_id" id="form-field-select-3" data-placeholder="Choose a Country...">
												...
												<?php foreach ($a_view_data['transport'] as $key => $value): ?>
												<option data="<?php echo $value['sprice'] ?>" value="<?php echo $value['id'] ?>"><?php echo $value['title'] ?></option>
												<?php endforeach ?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="goods_price" required="required" min="0" id="form-field-1" placeholder="商品价格" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="goods_marketprice" required="required" min="0" id="form-field-1" placeholder="市场价" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="goods_promotion_type" id="form-field-select-3" data-placeholder="Choose a Country...">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="goods_promotion_price" id="form-field-1" placeholder="商品促销价格" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="goods_discount" id="form-field-1" placeholder="商品折扣价格" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="goods_storage_alarm" id="form-field-1" placeholder="库存报警值" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" min="0" required="required" name="goods_click" id="form-field-1" placeholder="商品点击数量" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" min="0" required="required" name="goods_salenum" id="form-field-1" placeholder="销售数量" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="goods_collect" id="form-field-1" placeholder="收藏数量" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" min="0" required="required" name="goods_storage" id="form-field-1" placeholder="商品库存" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="deductible_point" id="form-field-1" placeholder="每个商品能使用的积分" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" min="0" required="required" name="goods_feng" id="form-field-1" placeholder="指定产品的赠送积分数" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="file" required="required" name="goods_image" id="form-field-1" placeholder="商品主图" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="payment" id="form-field-select-3" data-placeholder="Choose a Country...">
												...
												<option value="online">余额支付</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="evaluation_count" id="form-field-1" placeholder="评价数" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" name="evaluation_good_star" value="5" id="form-field-1" max="5" min="0" placeholder="好评星级" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="goods_lock" id="form-field-select-3" data-placeholder="Choose a Country...">
												...
												<option selected="selected" value="0">未锁</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select" name="goods_commend" id="form-field-select-3" data-placeholder="Choose a Country...">
												...
												<option selected="selected" value="1">不推荐</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="virtual_indate" value="0" id="form-field-1" placeholder="虚拟商品有效期" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required="required" min="0" name="virtual_limit" value="0" id="form-field-1" placeholder="虚拟商品购买上限" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea style="width:370px;height: 100px;" name="description" required="required"></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9" style="height:800px">
											<textarea id="editor" name="goods_body"></textarea>
										</div>
									</div>
