<template>
	<div class="index">
		...
		<div class="bottomNav">
			...
			<!--<div class="navItem" :class="{index : $store.state.path.to == '/find_job'}" @click="find_job()">
				<div class="logo find_job"></div>
				<div>赚钱</div>
			</div>-->
			<div class="navItem" :class="{index : $store.state.path.to == '/news'}" @click="news()">
				<div class="logo xinx"></div>
				<div>统计</div>
			</div>
			
			<!--<div class="navItem" :class="{index : $store.state.path.to == '/find_services'}" @click="find_services()">
