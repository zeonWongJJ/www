<template>
	<div class="my_kask">
		<div class="tit_box">
			<ul class="tit_box_ul">
				<li class="tit_box_li" @click.stop="my_task()">全部任务 </li>
		...
		<!--<Row class="fileHandle magbut" type="flex" justify="end">
			<Page :total="pageInfo.count" :current="pageInfo.page" :page-size="pageInfo.rows" show-elevator></Page>
		</Row>-->
	</div>
</template>
