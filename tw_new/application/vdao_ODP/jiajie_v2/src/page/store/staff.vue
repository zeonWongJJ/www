	...
	<div class="staff">
		...
		<div class="body" v-if="!more">
			<div class="li">
				<div>头像</div>
				<div class="img">
					<img :src="staff_data.user_pic.length == 0 ? default_img : staff_data.user_pic"/>
				</div>
			</div>
			<div class="li">
				<div>姓名</div>
			...
			<div class="row">
				<div class="item">
					<div class="img">
            			<img v-if="staff_data.store_zizhi_opposite.length > 0" :src="uploadFileUrl + staff_data.store_zizhi_opposite"/>
					</div>
					<div>资质证书正面照</div>
				</div>
				<div class="item">
					<div class="img">
            			<img v-if="staff_data.store_zizhi_positive.length > 0" :src="uploadFileUrl + staff_data.store_zizhi_positive"/>
					</div>
					<div>资质证书反面照</div>
				</div>
			</div>
