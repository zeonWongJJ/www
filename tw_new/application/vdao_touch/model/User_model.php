...
class User_model extends TW_Model
{
    ...
    {
        $i_result = $this->db->insert('messagess', $a_data);
        return $i_result;
    }
    ...
    public function get_user_referee($user_id, $i_page)
    {
        ...
        if ($i_page > $page_total) {
            return $a_data = ['code' => 400, 'msg' => '没有更多数据了'];
        }
        $a_data = $this->db->get('user', $a_where, $s_field, $a_order);
        return $a_data;
    }
    ...
    public function get_referee_search($keywords)
    {
        ...
        $a_data  = $this->db->get('user', $a_where, $s_field, $a_order, 0, 999999);
        return $a_data;
    }
    ...
    public function get_myreferees($user_id)
    {
        ...
        $a_data  = $this->db->get('user', $a_where, $s_field, $a_order, 0, 99999999);
        return $a_data;
    }
