...
<html>
    ...
    <!-- 拉框结束 -->
		<div class="main">
			<header class="head"><a href="user_center"><img src="static/style_default/images/yongping_03.png"/></a><i>设置</i></header>
			<div class="setList">
				<ul>
					<li class="safe"><a href="user_update">账户与安全<i></i></a></li>
					<!-- <li class="cache"><a href="javascript:;" onclick="dele();">清楚图片缓存<s></s></a></li> -->
