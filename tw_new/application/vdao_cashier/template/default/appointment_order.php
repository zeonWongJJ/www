		...
		<div class="main">
			...
			<div class="middle">
				...
				<div class="orderNav">
					...
					<a id ="appointment_order" class="navCur "  href="appointment_order.html">会议订单</a>
				</div>
				<!-- 订单导航 -->
									...
									<ul>
										<li>
											...
											<div class="userInfo">
												...
												<p><span>座位 - <?php echo $a_order['room_name'];?> </span></p>
											</div>
										</li>
										<li>
				...
				<!--分页开始-->
	        	<div class="page">
	        		<?php echo $this->pages->link_style_one($this->router->url('appointment_order-'.$a_view_data['number'].'-'.$a_view_data['code'].'-'.$a_view_data['state'].'-', [], false, false));?>
...
function jiedan(oid) {
	$.ajax({
		...
		type: "post",
		data: "appointment_id=" + oid + "&appointment_type=1",
		dataType: "json",
...
function dayi(oid) {
	$.ajax({
		...
		type: "post",
		data: "order_id=" + oid+ "&appointment_type =1",
		dataType: "json",
		success: function(result) {
...
$(".tipsBtn>em").click(function(){
    ...
    $.ajax({
        ...
        type: "post",
        data: "appointment_id=" + id1 + "&reason=" + name+ "&appointment_type =1",
        dataType: "json",
        success: function(res) {
