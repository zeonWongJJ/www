...
<div class="ordertime-cont">
  <span id="time-txt">
        ...
        <ul id="allTime">
            <li><a href="<?php echo $this->router->url('consume', ['while'=>'0', $a_view_data['i_page']]);?>" >近三个月收支明细
            </a></li>
            <li><a href="<?php echo $this->router->url("consume", ['while'=>'1', $a_view_data['i_page']]);?>" >今年内收支明细</a></li>
            <li><a href="<?php echo $this->router->url("consume", ['while'=>'2', $a_view_data['i_page']]);?>" >2016年收支明细</a></li>
            <li><a href="<?php echo $this->router->url("consume", ['while'=>'3', $a_view_data['i_page']]);?>" >2015年收支明细</a></li>
            <li><a href="<?php echo $this->router->url("consume", ['while'=>'4', $a_view_data['i_page']]);?>" >2014年收支明细</a></li>
            <li><a href="<?php echo $this->router->url("consume", ['while'=>'5', $a_view_data['i_page']]);?>" >2014年之前收支明细</a></li>
        </ul>
</div>                                   
  ...
  <div id="Balancerecord_con">
    <?php if (empty($a_view_data['consume']['thre'])) {?>
      <div class="product">
                        <ul>
                            <span class='t'>暂无消费记录.....</span>     
                        </ul>
                    </div>
    <?php } else {?>
   <table id="table_bg">
     <tbody>
     <?php foreach ( $a_view_data['consume']['thre'] as $value ) { ?>
       <tr>
         <td style="width: 150px; "><?php echo date('Y-m-d H:s A' , $value['lg_add_time']); ?></td>
         <td style="width: 100px; ">
         <div class="td_bg1" style="background-color:white">消费</div>
         </td>
         <td style="width: 100px; "><div class="autocut width100">-<?php echo $value['lg_av_amount']; ?></div></td>
         <td style="width: 200px; "><div class="autocut width200">购物订单号：<?php echo $value['order_sn']; ?></div></td>
         ...
         <div class="td_bg2">
         <div class="uptd_bg2" style="background-color:white; width:<?php if( $value['evaluation_state'] ){
          echo '200';
         }else{
...
<div id="Turnpage"> 
	<?php echo $a_view_data['consume']['page']; ?>
</div>
<?php }?>
<div class="clear"></div>
</div></div>
