...
<div class="ordertime-cont">
  <span id="time-txt">
        ...
        <ul id="allTime">
            <li><a href="<?php echo $this->router->url('recharge', ['while'=>'0', $a_view_data['i_page']]);?>" >近三个月收支明细
            </a></li>
            <li><a href="<?php echo $this->router->url("recharge", ['while'=>'1', $a_view_data['i_page']]);?>" >今年内收支明细</a></li>
            <li><a href="<?php echo $this->router->url("recharge", ['while'=>'2', $a_view_data['i_page']]);?>" >2016年收支明细</a></li>
            <li><a href="<?php echo $this->router->url("recharge", ['while'=>'3', $a_view_data['i_page']]);?>" >2015年收支明细</a></li>
            <li><a href="<?php echo $this->router->url("recharge", ['while'=>'4', $a_view_data['i_page']]);?>" >2014年收支明细</a></li>
            <li><a href="<?php echo $this->router->url("recharge", ['while'=>'5', $a_view_data['i_page']]);?>" >2014年之前收支明细</a></li>
        </ul>
</div>                                
  ...
  <?php if (empty($a_view_data['res']['thre'])) {?>
   ...
   <table id="table_bg">
     ...
     <?php foreach ( $a_view_data['res']['thre'] as $value ) { ?>
       <tr>
         <td style="width: 150px; "><?php echo date('Y-m-d H:s A' , $value['pdr_add_time']); ?></td>
         <td style="width: 100px; ">
         <div class="td_bg1" style="background-color:white">充值</div>
         </td>
         <td style="width: 100px; "><div class="autocut width100">+<?php echo $value['pdr_amount']; ?></div></td>
         <td style="width: 200px; "><div class="autocut width200"><?php echo $value['pdr_payment_name']; ?>转入</div></td>
         <td><span class="verticalline"></span></td>
         <td style=" width: 200px; text-align:left; "><div class="autocut width200">
         <?php if( $value['pdr_payment_state'] ){
              echo date('Y-m-d H:s A' ,$value['pdc_payment_time']).'转入成功';
         }else{
              echo '还没付款';
         } ?>
         </div></td>
         ...
         <div class="td_bg2">
         <div class="uptd_bg2" style="background-color:white; width:<?php if( $value['pdr_payment_state'] ){
          echo '200';
         }else{
          echo '100';
         } ?>px;">
