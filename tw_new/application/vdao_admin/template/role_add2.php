...
<head lang="en">
    ...
    <script src="./static/style_default/script/addRole.js"></script>
    <title>添加角色</title>
</head>
...
<div class="productClassification">
    ...
    <article>
        ...
        <!-- 角色列表 -->
        <div class="adminList">
            <p><a href="role_showlist" style="color:#000;">权限管理</a> > 添加角色</p>
        </div>
        <!-- 角色列表 -->
            ...
            <form action="role_add" method="post">
                <ul>
                    <li class="addRoleName">
                        <span>角色名称</span>
                        <input type="text" name="role_name" id="addRole_name"/>
                        <em>
                    ...
                    <li class="addRoleDescription">
                        <span>角色描述</span>
                        <textarea name="role_description" id="addRole_des" cols="30" rows="10"></textarea>
                        <em class="hide">
                            <img src="./static/style_default/image/t_03.png" />
                            <span></span>
                        </em>
