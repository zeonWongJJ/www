...
<!--     <link rel="stylesheet" type="text/css" href="static/style_default/style/wangEditor-1.1.0.css">
    ...
    <script src="static/style_default/script/addSlide.js"></script>
                ...
                <div class="slide_demand">
                    <form action="ad_add" method="post">
                        <ul>
                            <li class="slide_name">
                                <em><s>*</s>标题</em>
                                <input type="text" id="slideName" name="ad_title" placeholder="轮播标题"/>
                                <span class="hide">
                            ...
                            <li class="slide_num">
                                <em><s>*</s>序号</em>
                                <input type="text" id="slideNum" name="ad_order" placeholder="序号" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " onafterpaste="this.value=this.value.replace(/[^\d]/g,'') "/>
                                <span class="hide">
                                    <img src="static/style_default/image/t_03.png" />
                                    <em></em>
                                </span>
                            ...
                            <li class="slide_href">
                                <em><s>*</s>图片链接</em>
                                <input type="text" id="slideHref" name="ad_link" placeholder="图片链接(可不填)"/>
                                <span class="hide">
                                    <img src="static/style_default/image/t_03.png" />
                                    <em></em>
                                </span>
