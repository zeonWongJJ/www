                ...
                <form action="store_add" method="post">
                    <ul>
                        <li class="addStoreName">
                            <span>门店名称</span>
                            <input type="text" name="store_name" id="addStore_name"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                            </em>
                        </li>
                        <input type="hidden" name="store_state" value="1">
                        ...
                        <li class="addStoreAddress">
                            <span>门店地址</span>
                            <input type="text" name="store_address" id="addStore_address"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                            </em>
                        ...
                        <li class="addPassengerID">
                            <span>客流openID</span>
                            <input type="text" name="passenger_openid" id="addStore_address"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                            </em>
                        ...
                        <li class="addDistributionID">
                            <span>配送门店ID</span>
                            <input type="text" name="transport_id" id="addStore_address"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                             </em>
                        ...
                        <li class="addStoreNum">
                            <span>门店账号</span>
                            <input type="text" name="manager_name" id="addStore_Num"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                            </em>
                        ...
                        <li class="addStorePwd">
                            <span>门店密码</span>
                            <input type="password" name="manager_password" id="addStore_pwd"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                            </em>
                        ...
                        <li class="addStoreRePwd">
                            <span>确认密码</span>
                            <input type="password" name="manager_password2" id="addStore_rePwd"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                            </em>
                        ...
                        <li class="addStoreContact">
                            <span>联系人</span>
                            <input type="text" name="store_linkman" id="addStore_contact"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                            </em>
                        ...
                        <li class="addStorePhone">
                            <span>联系方式</span>
                            <input type="text" name="store_contact" id="addStore_phone"/>
                            <em class="hide">
                                <img src="./static/style_default/image/t_03.png" />
                                <span></span>
                            </em>
