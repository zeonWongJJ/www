...
<head lang="en">
    ...
    <link rel="stylesheet" href="static/style_default/style/cafeOrder.css"/>
    <script src="static/style_default/plugin/jquery-1.8.2.min.js"></script>
    <script src="static/style_default/script/public.js"></script>
    <script src="static/style_default/script/cafeOrder.js"></script>
    <title>餐饮订单</title>
</head>
    ...
    <article>
        ...
        <div class="cafeOrder">
            <div class="cafeTitle">
                ...
                <span>订单管理/爽爽挝啡(<?php echo $a_view_data['store']['store_name']?>)/</span>
                <em>餐饮订单</em>
            </div>
            <!-- 餐饮订单导航 -->
            <div class="cafeNav">
                <ul>
                    <li class="allOrder">
                        <a  href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 0,'i_canshu' => 1]); ?>" <?php if ($a_view_data['i_order'] == 0) {
                           echo "class='cafeCur'";}?>>所有订单</a>
                    </li>
                    <li class="pendingPayment">
                        <i></i>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 40,'i_canshu' => 1]); ?>" <?php if ($a_view_data['i_order'] == 40) {
                           echo "class='cafeCur'";}?>>待付款</a>
                        <em><?php echo $a_view_data['payment']?></em>
                    </li>
                    <li class="waitingList">
                        <i></i>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 20,'i_canshu' => 1]); ?>" <?php if ($a_view_data['i_order'] == 20) {
                           echo "class='cafeCur'";}?>>待接单</a>
                        <em><?php echo $a_view_data['waiting']?></em>
                    </li>
                    <li class="distribution">
                        <i></i>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 25,'i_canshu' => 1]); ?>" <?php if ($a_view_data['i_order'] == 25) {
                           echo "class='cafeCur'";}?>>待配送</a>
                        <em><?php echo $a_view_data['shipping']?></em>
                    </li>
                    <li class="inDistribution">
                        <i></i>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 30,'i_canshu' => 1]); ?>" <?php if ($a_view_data['i_order'] == 30) {
                           echo "class='cafeCur'";}?>>配送中</a>
                        <em><?php echo $a_view_data['distribu']?></em>   
                    </li>
                    <li class="cafeComplete">
                        <i></i>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 10,'i_canshu' => 1]); ?>" <?php if ($a_view_data['i_order'] == 10) {
                           echo "class='cafeCur'";}?>>已完成</a>
                    </li>
                    <li class="cafeCancel">
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 55,'i_canshu' => 1]); ?>" <?php if ($a_view_data['i_order'] == 55) {
            ...
            <div class="cafeListTitle">
                ...
                <span class="dealState" style="width:150px; position:relative;">
                    <a><?php if ($a_view_data['i_order'] == 0) {
                            ...
                            echo "配送中";
                        } else if ($a_view_data['i_order'] == 10 || $a_view_data['i_order'] == 80) {
                            echo "已完成";
                    ...
                    <div class="dealStateBox hide">
                        <a  href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 0,'i_canshu' => 1]); ?>">所有订单</a>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 40,'i_canshu' => 1]); ?>">待付款</a>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 20,'i_canshu' => 1]); ?>">待接单</a>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 25,'i_canshu' => 1]); ?>">待配送</a>
                         <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 30,'i_canshu' => 1]); ?>">配送中</a>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 10,'i_canshu' => 1]); ?>">已完成</a>
                        <a href="<?php echo $this->router->url('order_coffee', [$a_view_data['store_id'],'i_order' => 55,'i_canshu' => 1]); ?>">已关闭</a>
                    </div>
                    <script>
                        $(function(){
                ...
                <!-- <span style="width:212px;">操作</span> -->
            </div>
            <ul class="cafeListContent">
                        ...
                        <dd class="orderProgress">
                            <div>
                                ...
                                <div class="progressContentBg" >
                                    <div class="progressContent" style="<?php if ($order['order_state'] < 2) {
                                            echo "width: 0%";
                                        } else if ($order['order_state'] == 40) {
                                            echo "width: 15%";
                                        } else if ($order['order_state'] == 20) {
                        ...
                        <dd class="transactionState">
                            <div>
                                <?php if ($order['order_state'] < 2) {?>
                                    ...
                                    <?php }?>
                                <a href="javascript:;" style="color:black;" class="order_id" value="<?php echo $order['order_id']?>">订单详情</a>
        ...
        <!-- 餐饮列表 -->
         ...
         <!-- 分页 -->
        <div class="page">
            <?php echo $this->pages->link_style_one($this->router->url('order_coffee-'.$a_view_data['store_id'].'-'.$a_view_data['i_order'].'-', [], false, false)); ?>
            <span style="background:none">共计<em> <?php echo $a_view_data['i_total']; ?> </em>条数据</span>
        </div>
        <!-- 分页 -->

        <!-- 订单层 -->
        <div class="cafeOrders">
        </div>
        <!-- 订单层 -->
    </article>
    <!--  右侧内容 -->
