...
<div class="productClassification">
    ...
    <article>
        ...
        <div class="announcement">
            <p><a href="notice_showlist" style="color:#000;">公告管理</a> > 修改公告</p>
            <div class="ggTitle">
                <span>修改公告</span>
            </div>
        ...
        <div class="announcementList">
            <form id="addform" action="<?php echo $this->router->url('notice_update'); ?>" method="post">
            <input type="hidden" name="notice_id" value="<?php echo $a_view_data['notice_id']; ?>">
                <ul>
                    <li class="announcementTitle">
                        <span>公告标题</span>
                        <input type="text" name="notice_title" id="announTitle_name" value="<?php echo $a_view_data['notice_title']; ?>" style="width:50%;" />
                        <em class="hide">
                    ...
                    <li class="editBox" style="overflow:hidden;">
                        ...
                        <script id="editor" style="width:90%; height:300px; float:left;" name="notice_content" type="text/plain"><?php echo $a_view_data['notice_content']; ?></script>
                    </li>
                </ul>
            </form>
            <span id="announceSub">确定修改</span>
        </div>
        <!-- 发布公告 -->
