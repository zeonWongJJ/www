						...
						<div class="row">
											...
											<table id="" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a href="#"><?php echo $this->project_model->get_name($a_task['id_project']); echo ' / '; echo $this->project_model->get_name($a_task['id_project_parent']);?></a>
														</td>
														<td><?php echo $this->task_group_model->get_name($a_task['id_task_group']);?></td>
														<td><a href="<?php echo $this->router->url('task_home', [$a_task['id_task']]);?>"><?php echo $a_task['title'];?></a></td>
														<td>
															<div class="progress progress-animated progress-striped active">
																<div class="progress-bar progress-bar-warning"  data-percentage="<?php echo $a_task['ratio_finsh'];?>" style="line-height:13px">
								...
								<div class="modal-footer no-margin-top">
									<ul class="pagination pull-right no-margin">
										<li><?php echo $this->pages->link_style_one($this->router->url($this->router->get_index(), [''], false, false));?></li>
									</ul>
								</div>
					</div><!-- /.page-content -->
				</div>
