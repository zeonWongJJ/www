			...
			<transition name="service">
		    	<div class="list_container" v-show="navIndex == 1">
		    		<div class="list_dd" v-for="(ac,y) in service_list" >
						...
						<div class="listBox">
							<div class="img">
								<img :src="uploadFileUrl+ac.img" alt="" />
							</div>
							<ul class="right">
								<li>
	...
	export default {
		data() {
			return {
				...
				list:[],
				service_list: [{
		"service_name": "家洁清洁很干净",
		"service_info": "我的服务超级棒，一级棒，不干净不收钱哦",
		"img": "uploadfile\/20181122211202_.jpeg",
		"service_sold": "0",
		"service_is_show": "1"
	},{
		"service_name": "家洁清洁很干净",
		...
		"service_is_show": "1"
				...
				store_list:[{
		"store_name": "辉记清洁有限公司",
		"store_region": "广东省广州市番禺区",
		"store_address": "钟村街道长华创意谷1606",
		"store_info": "我是傻逼",
		"store_status": "1",
		"store_level": "1",
		"store_sold": "0",
		"img": "uploadfile\/20181122210703_.jpeg"
	},{
		"store_name": "辉记清洁有限公司",
		"store_region": "广东省广州市番禺区",
		"store_address": "钟村街道长华创意谷1606",
