...
<html>
    ...
    <!-- 拉框结束 -->
		<div class="main">
			<header class="head"><a href="javascript:history.back(-1);"><img src="static/style_default/images/yongping_03.png"/></a><i>我的评价</i></header>
			<div class="content">
				<ul id="commentullist">
...
function store_detail(store_id) {
	window.location.href = "store_newcomment-"+store_id;
}
