    ...
    <div class="makeOffice">
        ...
        <form id="seatform" action="<?php if ($_SESSION['appointment_type'] == 2) { echo 'office_appoint'; } else { echo 'office_appoint3'; }  ?>" method="post">
            <div class="storeName">
                ...
                价格：<span style="color:red;"><?php echo $a_view_data['office']['office_price']; ?>元/<?php if ($_SESSION['appointment_type'] == 1) { echo '小时'; } else { echo '个'; } ?></span>
            </div>
            <!-- 选择入座时间 -->
            <div class="seat">
                <ul>
            ...
            <div class="contact">
                <ul>
                    <li class="contactName">
                        <span>联系人</span>
                        <input type="text" name="linkman"  id="contact_name" placeholder="请填写联系人姓名"/>
                    </li>
                    <li class="contactPhone">
                        <span>联系电话</span>
                        <input type="text" name="link_phone" id="contact_phone"  placeholder="请填写联系人电话"  onkeyup="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li class="contactCode">
                        <input type="text" name="code"  placeholder="验证码" id="contact_code"/>
                        <em><input value="获取验证码" type="button" id="codeBtn" class="removeBtn"  onkeyup="this.value=this.value.replace(/\D/g,'')"></em>
                    </li>
                </ul>
            </div>
            <!-- 联系人 -->
