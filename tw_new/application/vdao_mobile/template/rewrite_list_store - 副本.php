...
<div class="box" style="position: relative; height:100%;">
    <!-- 头部 -->
    <div class="head">
        <a class="back" href="javascript:history.go(-1);"><img style="width:0.1rem;"
                                                               src="./static/rewrite/img/dongtai_05.png" alt=""/></a>
    ...
    <div class="body">
        <div id='mySwipe' class='swipe'>
            <div class='swipe-wrap'>
                <div><img src="./static/rewrite/img/tea.png"></div>
                <div><img src="./static/rewrite/img/tea.png"></div>
                <div><img src="./static/rewrite/img/tea.png"></div>
                <div><img src="./static/rewrite/img/search.png"></div>
            </div>
            <div class="row">
                <div class="back"></div>
                <div class="share"></div>
        ...
        <div class="info">
            <div class="price c_orange">￥15.00起</div>
            <div class="nameBox">
                <div class="name">柚子冰红茶</div>
        ...
        <div class="describe">
            ...
            <p> 柚子果酱，加上鲜甜的蜂蜜，配上爽口的柠檬，加上凉凉的冰块，美味就完成了</p>
        </div>
        <div class="valuation">
            <div class="top">
            ...
            <div class="valuaBox">
                <div class="valua">
                    ...
                    <div class="other">
                        ...
                        <div class="info">
                            <span class="type c_orange">[满意]</span> 干净卫生、食材新鲜，很满意，味道很好，服务态度很好，发货速度也快，赞一个！
                        </div>
                        <div class="imgs">
                            <img src="./static/rewrite/img/tea.png" alt="">
                            <img src="./static/rewrite/img/tea.png" alt=""><img src="./static/rewrite/img/tea.png"
                                                                                alt="">
                            <img src="./static/rewrite/img/tea.png" alt="">
                            <img src="./static/rewrite/img/tea.png" alt="">
                        </div>
    ...
    <div class="footer">
        <div class="shopCart_box">
            ...
            <div class="cartType">
                <span class="cart_typecur store_gi">外卖配送</span>
                <span class="">门店自取</span>
            </div>
            <div class="cartPrice">
        ...
        <a href="/new_bill?oldurl=<?php echo $this->router->get_url(); ?>" class="banc">结算</a>
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.forEach(function (val) {
                    var goods_href = 'item-' + '<?php echo $this->router->get(2);?>' + '-' + val.product_id + '-' + <?php echo $this->router->get(1);?> +'.html';
    ...
    */
    ...
    $("body").on("click", ".joinCart", function () {
        ...
        var product_id = $(this).parent().find('.product_id').attr('value');//product_id
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //获得评论列表
        function shop_comment(comment_type, comment_cate = 0) {
            var store_id = '<?php echo $this->router->get(1)?>';
            $.ajax({
                type: "post",
                url: "/shop_comment",
                data: {store_id: store_id, comment_type: comment_type, comment_cate: comment_cate},
                dataType: "json",
                success: function (data) {
                    var html = '';
                    if (data.data) {
...
//				$("img[ data-row='"+row+"'][data-table='"+table+"'][ data-seatType='"+seat+"' ]").attr("src","./static/rewrite/img/sa1.png");
        ...
        //    // 获取选座记录
        //    var seatBoxlists = $('.choice_seatBox').find('ul#choice_seatBox_list > li');
        //    var office_seat = [];
        //    var office_seatname = [];
        //    $.each(seatBoxlists, function (i, e) {
        //        office_seat.push($(this).data('id'));
        //        office_seatname.push($(this).text());
        //    });
