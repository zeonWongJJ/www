...
<body>
    ...
    <div class="address">
                ...
                <li class="listInfo li_<?php echo $addre['address_id']?>">
                    <dl>
                        ...
                        <dd class="addressTool">
                            ...
                            <div class="operation">
                                <a class="edit"  href="address_update-<?php echo $addre['address_id']?>?oldurl=<?php echo $_GET['oldurl'];?>">
        ...
        <!-- 新增地址 -->
        <a class="addAddress" href="<?php echo $this->router->url('address_add')?>?oldurl=<?php echo $_GET['oldurl'];?>">
