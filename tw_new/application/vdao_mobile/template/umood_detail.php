...
<html>
    ...
    <!-- 拉框结束 -->
		<div class="main">
			<header class="head"><a href="user_mood"><img src="static/style_default/images/kefu_03.png"/></a><i>动态详情</i></header>
			<div class="content clearfix">
				...
				<div class="picBox">
					...
					<div class="article">
						<p class="p1"><?php echo $a_view_data['user']['user_name']; ?></p>
				...
				<!--图片结束-->
				<!--加的转发框开始-->
				<?php if ($a_view_data['mood']['mood_type'] == 2) { ?>
                <div class="transmit clearfix">
                	<div class="tPic">
                		<a href="javascript:;">
                		<?php if (empty($a_view_data['mood']['replay_upic'])) {
                			echo '<img src="static/style_default/images/tou_03.png"/>';
                		} else {
                			echo '<img src="'.$a_view_data['mood']['replay_upic'].'"/>';
                		} ?>
                		</a>
                	</div>
                	<div class="tDescribe">
                		<p class="tMing"><a href="umood_detail-<?php echo $a_view_data['mood']['replay_mid']; ?>">@<?php echo $a_view_data['mood']['relay_uname']; ?></a></p>
                		<p class="tMiao"><a href="umood_detail-<?php echo $a_view_data['mood']['replay_mid']; ?>"><?php echo $a_view_data['mood']['replay_mcon']; ?></a></p>
                	</div>
                </div>
                <?php } ?>
                <!--加的转发框结束-->
				<!--点赞开始-->
				<div class="goodBox goodBox1 clearfix">
					...
					<div class="people">
						<ul>
							...
							<?php $i++; endforeach ?>
							<?php if (count($a_view_data['like']) > 2) { ?>
						...
						<li>
							...
							<div class="dRight">
								<p class="name">
									...
									<span>
									<?php echo date('m-d', $value['discuss_time']); ?>
									</span>
								</p>
								<p class="discuss">
									<a href="javascript:;"></a>
