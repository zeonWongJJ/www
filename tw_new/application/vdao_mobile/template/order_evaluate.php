...
<html>
    ...
    <!-- 拉框结束 -->
		<div class="main">
			<header class="head">
				<a class="back" style="top:0.15rem;" href="javascript:;"><img src="static/style_default/images/yongping_03.png"/></a>
				<i>产品评价</i>
				<a class="submit" style="top:0.15rem;" href="javascript:;">提交</a>
			</header>
			<div class="shopName">
				<div class="pic">
