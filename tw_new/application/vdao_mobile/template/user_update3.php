		...
		<div class="main">
			...
			<div class="information account">
				<ul>
					...
					<li class="phone"><a href="javascript:;">手机号<i></i><b>
					...
					<li class="qq"><a href="javascript:;" value="<?php if (empty($a_view_data['user']['qq_openid'])) { echo '1'; } else { echo '2'; }; ?>" >QQ<i></i><b <?php if (empty($a_view_data['user']['qq_openid'])) { echo 'class="off"'; } ?>>
					<?php if (empty($a_view_data['user']['qq_openid'])) {
						echo "点击绑定";
					} else {
						echo $a_view_data['user']['qq_nickname'];
					} ?>
					</b></a></li>
					<li class="weixin"><a href="javascript:;" value="<?php if (empty($a_view_data['user']['weixin_openid'])) { echo '1'; } else { echo '2'; }; ?>">微信<i></i><b <?php if (empty($a_view_data['user']['weixin_openid'])) { echo 'class="off"'; } ?>>
