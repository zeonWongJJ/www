	    ...
	    <div class="task">
			<form action="taskdel" method="post">
				<div class="logininput">
					标题 ：<input type="text" name="title" value="<?php echo $a_view_data['title'];?>">
					<br>
					内容 ：
						<textarea name="content" style="width:500px;height:200px;visibility:hidden;"><?php echo $a_view_data['content'];?></textarea>
					执行人 ：
					<select id="executor" name="executor">
						<option value="<?php echo $a_view_data['executor'];?>"><?php echo $a_view_data['name'];?></option>
					...
					<br>
					任务开始时间 ：<input type="text" class="sang_Calender" name="start" value="<?php echo $a_view_data['time_start'];?>">
					<br>
					任务结束时间 ：<input type="text" class="sang_Calender" value="<?php echo $a_view_data['time_end'];?>" name="end">
				</div>
