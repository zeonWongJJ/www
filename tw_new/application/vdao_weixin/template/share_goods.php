...
<body>
    ...
    <div class="productShare">
        <p class="pjoTitle">
            <a href="classification_share-<?php echo $this->router->get(1);?>"><img src="static/style_default/images/lefB.png" alt=""/></a>
            <span>糖果/巧克力</span>
        </p>
        <div class="productContainer">
            <form action="share_goods" method="post" enctype="multipart/form-data">
                <input type="hidden" name="proid_id_1" value="<?php echo $this->router->get(1);?>">
                <input type="hidden" name="proid_id_2" value="<?php echo $this->router->get(2);?>">
                <input type="hidden" name="proid_id_3" value="<?php echo $this->router->get(3);?>">
                <!-- 上传图片 -->
                <div class="container">
                    <!--    照片添加    -->
                    <div class="z_photo">
                ...
                <div class="productInfo">
                    <ul>
                        <li class="productName">
                            <span>产品名称</span>
                            <input type="text" id="product_name" placeholder="x-xx字" name="product_name" />
                        </li>
                        <li class="productPrice">
                            <span>单价</span>
                            <input type="text" id="product_price" placeholder="请输入产品单价" name="price" />
                        </li>
                        <li class="productLicence">
                            <span>许可证号</span>
                            <input type="text" id="product_licence" placeholder="请输入产品许可证号" name="goods_license" />
                        </li>
                        <li class="productDescribe">
                            <span>产品描述</span>
                            <textarea name="pro_details" id="product_describe" cols="30" rows="10" placeholder="请输入产品描述"></textarea>
                        </li>
                    </ul>
                </div>
                <!-- 产品信息 -->
                    ...
                    <ul>
                        <li class="deliver">
                            ...
                            <a class="regionChoice">
                                <span class="region_mychoose">请选择</span>
                        ...
                        <li class="productAddress">
                            <span>详细地址</span>
                            <input type="text" id="product_address" placeholder="例:1号楼1单元101室" name="addre" />
                        </li>
                        <li class="productDelive">
                            <span>配送费</span>
                            <input type="text" id="product_delive" placeholder="请输入配送费" name="distribution" />
                        </li>
                    </ul>
                </div>
                <!-- 产品地址 -->
