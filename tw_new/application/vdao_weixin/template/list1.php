            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="spec li_<?php echo $prod['product_id']?>">
                        ...
                        <?php }}?>
                        <div class="shopPrice">
                            <span id="ouate">￥<?php $i = 0; foreach ($a_view_data['cup'] as $cup) {if ($prod['product_id'] == $cup['product_id']) {if ($i == 0) {echo $cup['price'];}$i++;}}?></span>(<em></em><dfn></dfn><s style="text-decoration:none; vertical-align:middle;"></s>)
                        </div>
