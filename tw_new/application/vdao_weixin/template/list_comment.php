...
<html>
    ...
    <!-- 拉框结束 -->
		<div class="main">
			<header class="head">
				<a class="back" href="<?php echo $this->router->url('item', [$a_view_data['i_lexin'], $a_view_data['goods_id'],$a_view_data['store_id']]); ?>"><img src="static/style_default/images/yongping_03.png"/></a>
				<i>咖啡评价</i>
			</header>
			<div class="tagBox">
				<ul>
