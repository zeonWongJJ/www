...
<html>
    ...
    <body class="body1">
        ...
        <div class="container1">
                <form class="contact_form1" action="<?php echo $this->router->url('login_auth');?>" method="post" name="contact_form">
                    <ul>
                      <li style=" margin-top:0px; border-color:#43d854;">
                        ...
                        <li>
                         ...
                         <li style="height:12px; margin-top:55px;">
                            ...
                            <ul>
            <li style="width:55px;"><a href="#"><img src="image/qq.png" width="24" height="24" border="none">QQ</a></li>
          
			<li><a href="#"><img src="image/wechat.png" width="24" height="24" border="none">微信</a> </li>
			<li><a href="#"><img src="image/weibo.png" width="24" height="24"  border="none">微博</a></li>
                            </ul>
