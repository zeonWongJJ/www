...
<header class="header">
    ...
    <div class="userDetails">
        <i>
            <img src="<?php echo $a_view_data['mybaseinfo']['photo']; ?>" alt=""/>
        </i>
        <div class="userInfo">
...
<nav class="account">
    ...
    <div class="accountBox">
        ...
        <!--  充值 -->
        <div class="rech">
            <a href="<?php echo $this->router->url('user_recharge'); ?>">充值</a>
            <a>提现</a>
        </div>
        <!-- 充值-->
    </div>
    ...
    <div class="nav">
        ...
        <a href="<?php echo $this->router->url('get_mycollect'); ?>">
            <p>收藏</p>
    ...
    <ul>
        <li>
            <a href="<?php echo $this->router->url('demand_detail',['id'=>1]); ?>">
                <p>全部订单</p>
                <p><?php echo $a_view_data['all_order']; ?></p>
            </a>
        </li>
        <li>
            <a href="<?php echo $this->router->url('demand_detail',['id'=>1]); ?>">
...
<div class="cataList">
    <ul>
        <li>
            <a href="<?php echo $this->router->url('user_mymoney'); ?>">
                <em>
                    <i class="iconfont">&#xe835;</i>
                    <span>交易记录</span>
                </em>
