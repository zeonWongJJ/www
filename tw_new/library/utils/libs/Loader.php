...
class Loader
{
    ...
    {
        // 注册系统自动加载
        spl_autoload_register($autoload ?: 'utils\\Loader::autoload', true, true);
        $rootPath = self::getRootPath();
//        self::$composerPath = $rootPath . 'library' . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR . 'composer' . DIRECTORY_SEPARATOR;
        self::$composerPath = BASEPATH . 'library' . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR . 'composer' . DIRECTORY_SEPARATOR;
        // Composer自动加载支持
    ...
    public static function factory($name, $namespace = '', ...$args)
    {
        ...
        if (class_exists($class)) {
            ...
            throw new \RuntimeException('class not exists:' . $class, $class);
        }
    }
}
/**
