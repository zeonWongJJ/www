        ...
        <div class="bottom clearfix">
	        ...
	        <div class="rightSide">
	        	...
	        	<div class="rightDown">
	        		...
	        		<div class="wrapBox">
	        			 <!--申请耗材开始-->
	        			<form action="<?php echo $this->router->url('consumable_addition'); ?>" method="post">
	        			 <div class="basicBox clearfix">
	        			 	<div class="bLeft">
	        			 		<ul>
	        			 			<li>
	        			 				<p class="smallTitle">门店名称</p>
	        			 				<p class="fill" ><?php echo $a_view_data['store']['store_name']?></p>
        			 				</li>
	        			 			<li>
	        			 				<p class="smallTitle">门店地址</p>
	        			 				<p class="fill"><?php echo $a_view_data['store']['store_address']?></p>
	        			 				<input type="hidden" name="store_address" value="<?php echo $a_view_data['store']['store_address']?>">
	        			 			</li>	        			 			
	        			 				...
	        			 				<div class="fillBox">	        			 					
	        			 					...
	        			 					<div class="typeBox">
	        			 						...
	        			 						<div class="productBox materialBox">
	        			 							<p class="lack">库存紧缺的耗材：<?php if (empty($a_view_data['consu'])) {
	        			 								echo "无";
	        			 			...
	        			 			<li class="phone total">
	        			 				...
	        			 				<div class="fillBox">
	        			 					<input type="text" class="int mobile" placeholder="请输入手机号码" name="phone"/>
	        			 				</div>
	        			 				<div class="tipsBox">
	        			 			...
	        			 			<li class="traffic introduce">
	        			 				...
	        			 				<div class="fillBox">
	        			 					<textarea class="txt" placeholder="请输入门店介绍..." name="shop_remark"></textarea>
	        			 		...
	        			 		<div class="addBox">
	        			 			...
	        			 			<div class="productAdd productAdd1">
		        			 			...
		        			 			<!-- <div class="singleAdd">
		        			 				<ul>
		        			 					<li class="first">
		        			 						<span class="addName"><s>拿铁咖啡</s>（<i>大杯</i>）</span>
		        			 						<span class="addNum"><s>10</s>份</span>
		        			 						<span class="addCon">
		        			 					...
		        			 					<li class="second">
		        			 						<span class="addName"><s>拿铁咖啡</s></span>
		        			 						<span class="addNum"><s>10</s>份</span>		        			 						
		        			 					</li>
		        			 					<li class="second">
		        			 						<span class="addName"><s>拿铁咖啡</s></span>
