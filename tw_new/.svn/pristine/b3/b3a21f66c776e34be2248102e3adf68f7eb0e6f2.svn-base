...
$(function(){
    ...
    //正则
    var addStoreReg={
        addStoreName:/^[0-9a-zA-Z\u4e00-\u9fa5_]{1,14}$/,//门店名称
    ...
    //初始化提交状态
    var initState={
        addStoreName:true,//门店名称
        addStoreAbled:true,//启用/暂用
        addStoreAddress:true,//门店地址
        addStoreNum:true,//门店账号
        addStoreMobile:true,//手机号码
        addStoreLine:true,//固话
        addStorePwd:true,//密码
        addStoreRePwd:true,//二次密码
        addStoreContact:true//联系人
    };
