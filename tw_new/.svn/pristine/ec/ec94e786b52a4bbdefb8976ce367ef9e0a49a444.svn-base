        ...
        <div class="bottom clearfix">
	        ...
	        <div class="rightSide">
	        	...
	        	<div class="rightDown">
	        		...
	        		<div class="wrapBox">
	        			 <!--申请耗材开始-->
	        			<form action="<?php echo $this->router->url('consumable_reapply'); ?>" method="post">
	        			 	...
	        			 	<div class="bLeft">
	        			 		<ul>
	        			 			...
	        			 			<li class="phone total">
	        			 				...
	        			 				<div class="fillBox">
	        			 					<input type="text" class="int mobile" value="<?php echo $a_view_data['con']['phone']?>" name="phone"/>
	        			 				</div>
	        			 				<div class="tipsBox">
