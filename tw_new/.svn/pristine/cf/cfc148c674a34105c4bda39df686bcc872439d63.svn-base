...
public class XhsEmoticonsKeyBoard extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    protected RecordSoundImageView mBtnVoice;
    ...
    private EmoticonsEditText.OnCommitContentListener listener;
    public void setEditTextCommitContentListener(
            EmoticonsEditText.OnCommitContentListener listener) {
    ...
    protected void initView() {
        ...
        mBtnVoice = ((RecordSoundImageView) findViewById(R.id.btn_voice));
    ...
    public final void setText(final CharSequence text) {
        mEtChat.post(new Runnable() {
            @Override
            public void run() {
                mEtChat.setText(text);
                if (text.length() > 0) {
                    mEtChat.setSelection(text.length());
    ...
    protected void initEditView() {
        ...
        getBtnSend().setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                String messageText = mEtChat.getText().toString().trim();
                Log.i("aaaaa",messageText);
    ...
    public RecordSoundImageView getBtnVoice() { return mBtnVoice; }
