...
<body>
    ...
    <div class="credentials">
        <p class="pjoTitle">
            <a href="myshare"><img src="static/style_default/images/yongping_03.png" alt=""/></a>
            <span>资质认证</span>
        </p>
        <div class="joinList">
            <form action="qualifi" method="post"  id="qualifi">
                <!-- 营业执照 -->
                <ul class="licenseList">
                    ...
                    <li class="regNum">
                        <span>注册号</span>
                        <input type="text" placeholder="注册号或统一社会信用代码" name="business_hao" />
                    </li>
                    <li class="licenseName">
                        <span>执照名称</span>
                        <input type="text" placeholder="营业执照名称这一行的内容" name="business_name" />
                    </li>
                    <li class="region">
                        <span>所在地区</span>
                    ...
                    <input type="hidden" name="unit_province">
                    <input type="hidden" name="unit_city">
                    <input type="hidden" name="unit_district">
                    <li class="address">
                        <span>详细地址</span>
                        <input type="text" placeholder="例：1号楼1单元101室" name="unit_address" />
                    </li>
                    <li class="legalName">
                        <span>法人姓名</span>
                        <input type="text" placeholder="请输入法人姓名" name="unit_legal_name" />
                    </li>
                    <li class="legalName">
                        <span>有效期</span>
                        <div class="legalChoiceBox">
                            <a class="legalLongTime legCur">
                                <img src="static/style_default/images/redbag_06.png" alt=""/>
                                <span>长期有效</span>
                            </a>
                            <a class="legalChoiceTime" style="margin-left:0.37rem;">
                    ...
                    <input type="hidden" name="business_imt" value="9">
                </ul>
                <!-- 营业执照 -->
                <!-- 申请人 -->
                <ul class="applicant">
                    <li class="apply">
                        ...
                        <div class="applyChoiceBox">
                            <a class="applyLongTime legCur">
                                <img src="static/style_default/images/redbag_06.png" alt=""/>
                                <span>法人申请</span>
                            </a>
                            <a class="applyChoiceTime" style="margin-left:0.37rem;">
                                <img src="static/style_default/images/redbag_10.png" alt=""/>
                                <span>非法人申请</span>
                            </a>
                        </div>
                        <input type="hidden" name="applicant" class="applicant" value="1">
                    </li>
                    <li class="legalIDcard" onclick="choose_pic(2,2)">
                        <span>法人身份证</span>
                        <a class="legalIDcardPic">
                            <span>请上传法人身份证图片</span>
                            <img src="static/style_default/images/shezhi_03.png" alt=""/>
                        </a>
                    </li>
                    <li class="legalIDcardNum">
                        <span>法人身份证号</span>
                        <input type="text" id="legal_id_card" placeholder="请输入法人身份证号码" name="unit_legal_number" />
                    </li>
                    <li class="applyName" style="display: none;">
                        <span>申请人姓名</span>
                        <input type="text" placeholder="请输入申请人姓名" name="applicant_name" />
                    </li>
                    <li class="applyIDcard" onclick="choose_pic(3,2)" style="display: none;">
                        <span>申请人身份证</span>
                        <a class="applyIDcardPic">
                            <span>请上传申请人身份证图片</span>
                            <img src="static/style_default/images/shezhi_03.png" alt=""/>
                        </a>
                    </li>
                    <li class="applyIDcardNum" style="display: none;">
                        <span>申请人身份证号</span>
                        <input type="text" id="apply_id_card" placeholder="请输入申请人身份证号码" name="applicant_number" />
                    </li>
                </ul>
                <!-- 申请人 -->
                <input type="hidden" name="business_imge">
                <input type="hidden" name="unit_legal_imge">
                <input type="hidden" name="identity_positive_url">
                <input type="hidden" name="identity_native_url">
                <input type="hidden" name="applicant_imge">
                <input type="hidden" name="applicant_imge_positive">
                <input type="hidden" name="applicant_imge_native">
                <!-- 联系方式 -->
                <ul class="contactCon">
                    <li class="contactPhone">
                        <span>联系电话</span>
                        <input type="text" id="contact_phone" placeholder="请输入手机号" name="phone" />
                    </li>
    ...
    if (isAndroid) {
       ...
       var callbackSuccess = function(json){
        ...
        if (type == 1 && code==1) {
            ...
            var obj = {"uploadClickType":code, "business_license_url": business_license_url, "type":type}
        } else if (type == 2 && code==2) {
            var identity_positive_url = $("input[name='identity_positive_url']").val();
            var identity_native_url = $("input[name='identity_native_url']").val();
            var obj = {"uploadClickType":code, "identity_positive_url":identity_positive_url, 'identity_native_url':identity_native_url, "type":type }
        } else if(type == 3 && code==2) {
            var applicant_imge_positive = $("input[name='applicant_imge_positive']").val();
            var applicant_imge_native = $("input[name='applicant_imge_native']").val();
            var obj = {"uploadClickType":code, "identity_positive_url":applicant_imge_positive, 'identity_native_url':applicant_imge_native, "type":type}
        }
