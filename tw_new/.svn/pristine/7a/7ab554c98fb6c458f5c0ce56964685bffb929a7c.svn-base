                    ...
                    <div class="aside_bar">
                        ...
                        <div class="prom">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="img" href="/good_details-<?php echo $value['goods_id']?>" style="background-image: url(<?php echo get_config_item('img_path').$a_view_data['rexiao'][$key]['store_id'].'/'.$value['goods_image']?>)"></a>
