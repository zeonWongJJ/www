        ...
        <div class="bottom clearfix">
	        ...
	        <div class="rightSide">
	        	...
	        	<div class="tableModule">
	        		...
	        		<div class="tabNav">
	        			<ul>
	        				<li><a href="<?php echo $this->router->url('coffee_room'); ?>">餐饮订单评价</a></li>
	        				<li class="current"><a href="comment_room">会议订单评价</a></li>
	        			</ul>
	        		</div>
	        		<!--切换导航结束-->
	        		<!--表格列表开始-->
	        		<div class="tableBox">
	        			<ul>
	        				...
	        				<li class="thead">
	        					<span>
	        						<span class="state">
		        						...
		        						<ul class="stateSelect">
		        							<li><a href="comment_room-9">全部</a></li>
		        							<li><a href="comment_room-1">好评</a></li>
		        							<li><a href="comment_room-2">中评</a></li>
		        							<li><a href="comment_room-3">差评</a></li>
		        						</ul>
		        						<div class="zhe"></div>
		        					</span>
	        					</span>
	        					...
	        					<span>
	        						<span class="state">
		        						...
		        						<ul class="stateSelect">
		        							<li><a href="comment_room-9-9">全部的状态</a></li>
		        							<li><a href="comment_room-9-1">有评论内容</a></li>
		        							<li><a href="comment_room-9-2">无评论内容</a></li>
		        						</ul>
		        						<div class="zhe"></div>
		        					</span>
	        					</span>
	        				...
	        				<li class="row" id="comment_<?php echo $value['comment_id']; ?>">
	        							...
	        							<ul>
	        								<?php
	        									...
	        									for ($i=0; $i<count($imgs); $i++) {
	        										echo '<li><img style="width:70px;" src="'.get_config_item('vdao_mobile').$imgs[$i].'"/></li>';
	        									}
	        								?>
	        							</ul>
	        						</div>
	        					...
	        					<span><?php if ($value['is_anonymous'] == 1) { echo '匿名用户'; } else { echo $value['user_name']; }; ?></span>
	        					<span><?php echo $value['room_name'].$value['office_seatname']; ?></span>
        	...
        	<div class="page" style="margin-bottom:30px;">
        		<?php echo $this->pages->link_style_one($this->router->url('comment_room-'.$a_view_data['comment_cate'].'-'.$a_view_data['comment_empty'].'-', [], false, false)); ?>
	        ...
	        <!--删除评论弹框结束-->
	        <input type="hidden" name="comtag_type" value="1">
	        <!--标签管理弹框开始-->
	        <div class="tagBomb">
	        	<div class="h2">
	        	...
	        	<div class="navBox">
	        		<div class="navL">
	        			<a href="javascript:;" class="nCoffee">咖啡</a>
	        			<a href="javascript:;" class="nRoom aCur">房间</a>
	        		</div>
	        		<div class="addR">
	        	...
	        	<div class="commentBox">
	        		<!--咖啡标签开始-->
	        		<div class="coffeeCom coffeeCom1" style="display: none;">
	        			<div class="cofWrap">
	        		...
	        		<!--咖啡标签结束-->
	        		<!--房间标签开始-->
	        		<div class="coffeeCom roomCom" style="display: block;">
	        			<div class="cofWrap">
		        			<div class="good good1">
		        				<P class="tit">好评</P>
		        				<div class="comList">
