...
<form class="layui-form">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="auth_name" required lay-verify="required" placeholder="请输入权限名称" autocomplete="off" class="layui-input" value="<?php echo $a_view_data['detail']['auth_name']; ?>">
    </div>
  </div>
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <select name="auth_pid" lay-verify="required">
        ...
        <option value="<?php echo $value['auth_id']; ?>" <?php if ($value['auth_id'] == $a_view_data['detail']['auth_pid']) { echo 'selected'; } ?>><?php echo $value['auth_name']; ?></option>
        <?php endforeach ?>
      </select>
    </div>
  </div>
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="auth_url" placeholder="请输入路由" autocomplete="off" class="layui-input" value="<?php echo $a_view_data['detail']['auth_url']; ?>">
    </div>
  </div>
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label">权限描述</label>
    <div class="layui-input-inline" style="width:300px;">
      <textarea name="auth_description" placeholder="请输入内容" class="layui-textarea"><?php echo $a_view_data['detail']['auth_description']; ?></textarea>
    </div>
  </div>
  <div class="layui-form-item">
