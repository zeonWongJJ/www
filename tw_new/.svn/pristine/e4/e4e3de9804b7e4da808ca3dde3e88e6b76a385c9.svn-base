...
<html>
    ...
    <!-- 拉框结束 -->
		<div class="main">
			<header class="head"><a href="nuser_center"><img src="./static/style_default/images/gouxiang_18.png"/></a><i>会议订单</i></header>
			<nav class="nav clearfix">
				<ul>
					...
					<li <?php if ($a_view_data['state'] == 2) { echo 'class="current"'; } ?>><a href="order_office-2">已接单</a></li>
					<li <?php if ($a_view_data['state'] == 3) { echo 'class="current"'; } ?>><a href="order_office-3">进行中</a></li>
