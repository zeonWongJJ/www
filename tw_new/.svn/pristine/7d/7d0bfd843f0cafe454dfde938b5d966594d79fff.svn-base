...
public class CommonKey {
    ...
    public final static String KEY_RESET_CURRENT_FRAGMENT="key_reset_current_fragment";
    ...
    public static String KEY_LOAD_ALL_CHINA_CITY_FINISH="key.load.all.city.finish";//是否第一次成功加载完城市列表标记
