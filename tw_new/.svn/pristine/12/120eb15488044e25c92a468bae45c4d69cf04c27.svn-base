...
public class StoreLocationActivity extends AbsBaseActivity implements LocationSource, AMapLocationListener, AMap.OnCameraChangeListener/*,AMap.OnMarkerClickListener*/ {
