...
<body>
    ...
    <div class="webAddress">
        ...
        <div class="addressForm">
            <form action="address_update?oldurl=<?php echo $_GET['oldurl'];?>>" method="post">
                <ul class="addressContainer">
                    <input type="hidden" name="id" value="<?php echo $a_view_data['address_id']?>">
                    <li class="userName">
                        <span>联系人</span>
                        <input type="text" id="user_name" value="<?php echo $a_view_data['user_name']?>" name="name" />
                    </li>
                    <li class="userSex" style="padding-left:2rem;">
                        <em class="man">
                            <?php if ($a_view_data['nei'] == 1) {
                              echo '<img src="static/style_default/images/redbag_06.png" alt=""/>';
                            } else { 
                              echo '<img src="static/style_default/images/redbag_10.png" alt=""/>';}?>    
                            <span>先生</span>
                        </em>
                        <em class="lady">
                    ...
                    <li class="userPhone">
                        <span>手机号</span>
                        <input type="text" id="user_phone" value="<?php echo $a_view_data['mob_phone']?>" name="mob"/>
                    </li>
                    <li class="region">
                        <span>所在地区</span>
                        <a class="regionChoice">
                            <span class="region_mychoose"><?php echo $a_view_data['address']?></span>
                    ...
                    <input type="hidden" name="address" value="<?php echo $a_view_data['address']?>">
                    <input type="text" id="user_address"  value="<?php echo $a_view_data['house']?>" name="house"/>
