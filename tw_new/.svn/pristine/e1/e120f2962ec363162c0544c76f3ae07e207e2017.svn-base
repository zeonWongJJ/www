...
<body>
	<form action="<?php echo $this->router->url('guarantee_custom_service'); ?>" method='post' enctype="multipart/form-data">
	...
	<input type="hidden" name="present_state" value="<?php echo $a_view_data['present_state']; ?>">
