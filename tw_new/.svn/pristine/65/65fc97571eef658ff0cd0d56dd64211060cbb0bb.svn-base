    ...
    data() {
      return {
        ...
        share: {
          ...
          , link: `${this.test(window.config.touchURL)}/#/share?userid=${this.$route.query.user_id}`
        ...
        , shareLine: `${this.test(window.config.touchURL)}/#/share?userid=${this.$route.query.user_id}`
      }
    },
    mounted() {
