				...
				<div class="com_box">
					<ul>
						<li class="list_coms">
							...
							<div class="order_but">
								<div v-if="addslists.order_detail.order_state == 0 || addslists.order_detail.order_state == 1 || (addslists.order_detail.order_state == 2 && addslists.order_detail.order_rate == 0)" class="but_coms_but1" @click.stop="shows(addslists)">取消订单
								</div>
								<div v-if="addslists.order_detail.order_state == 0 && addslists.order_detail.order_rate == 0" class="but_coms_but3" @click.stop="payShow(addslists)">去支付
								</div>
								<!--<div v-if="its.order_state == 1" class="but_coms_but3" @click.stop="ofgshow(its, index)"></div>-->
								<div v-if="addslists.order_detail.order_state == 1  || addslists.order_detail.order_state == 2 && addslists.order_detail.order_rate == 0" class="but_coms_but4" @click="call(addslists)">联系商家
								</div>
								<template v-if="addslists.order_detail.order_comment_id == 0 && addslists.order_detail.order_state == 3 && addslists.order_detail.order_rate == 1">
								...
								<div v-if="addslists.order_detail.order_state == 4 || addslists.order_detail.order_rate == 1 || addslists.order_detail.order_rate == -1 || addslists.order_detail.order_state == 5" class="but_coms_but1" @click.stop="shows(addslists)">
									删除订单
								</div>
							</div>
						</li>
