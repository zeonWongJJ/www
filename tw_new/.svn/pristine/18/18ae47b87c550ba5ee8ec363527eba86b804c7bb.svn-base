			...
			<div class="stateBox">
				...
				<?php } else if ($a_view_data['list'][0]['order_state'] == 20) {?>
					...
					<div class="state clearfix waitCarry">
						...
						<p class="p3">
							<?php if(empty($a_view_data['list'][0]['store_contact'])){ } else {?>
							<a href="tel:<?php echo $a_view_data['list'][0]['store_contact']?>" class="conSeller">联系商家</a>
							<?php }?>
							<?php if ($a_view_data['list'][0]['order_time'] < strtotime("-5 minute")) {
