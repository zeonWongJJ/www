<?php
class Express_model extends TW_Model {
        //错误码 
        private $errorNum;
        //错误信息
    ...
    */
    public function express($order_id,$flow=null){
        ...
        //获取物流公司编号
        $this->express_code=$this->get_express_data($order_id);
   
        if(empty($this->express_code)){
        ...
        //获取最新的物流数据
        $this->express_num=$this->get_express_num($order_id);
