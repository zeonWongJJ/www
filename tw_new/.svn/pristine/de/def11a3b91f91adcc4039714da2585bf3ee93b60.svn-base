...
public class StatusViewLayout extends FrameLayout {
    ...
    private TextView lib_action_empty_msg;
    ...
    private void setUpView() {
        ...
        lib_action_empty_msg=(TextView) mEmptyView.findViewById(R.id.lib_action_empty_msg);
    ...
    public void showEmpty(String msg,String actionMsg) {
        if(actionMsg!=null){
            lib_action_empty_msg.setText(actionMsg);
        }
