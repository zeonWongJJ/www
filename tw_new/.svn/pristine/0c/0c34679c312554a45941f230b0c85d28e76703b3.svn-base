...
public class RoomListItemViewHolder extends RecyclerView.ViewHolder {
  ...
  public RoomListItemViewHolder(RoomListItemView itemView, RoomListAdapter.OnItemClickListener listener,String hostname) {
    super(itemView);
  ...
  public void bind(RoomSidebar roomSidebar) {
    ...
    itemView.setUserIcon(hostname,roomSidebar.getRoomName());
  ...
  public void bind(Spotlight spotlight) {
    ...
    itemView.setUserIcon(hostname,spotlight.getName());
