...
public class RocketChatCache {
  ...
  private static final String KEY_DIRECT_MESSAGE_TYPE = "KEY_HOSTNAME_LIST";
  ...
  public String getSelectedRoomDirectMessageType() {
    return getString(getSelectedServerHostname() + KEY_DIRECT_MESSAGE_TYPE, null);
  }

  public void setSelectedRoomDirectMessageType(String roomId) {
    setString(getSelectedServerHostname() + KEY_DIRECT_MESSAGE_TYPE, roomId);
  }
