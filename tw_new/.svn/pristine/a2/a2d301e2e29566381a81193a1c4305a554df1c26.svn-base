    ...
    <div class="makeOffice">
        ...
        <form id="seatform" action="office_appoint3" method="post">
            <div class="storeName">
                ...
                价格：<span style="color:red;"><?php echo $a_view_data['office']['office_price']; ?>元/<?php if ($_SESSION['appointment_type'] == 1) { echo '小时'; } else { echo '个'; } ?>
                </span>
            </div>
            <!-- 选择入座时间 -->
            <div class="seat">
            ...
            <div class="contact">
                <ul>
                    ...
                    <li class="contactPhone">
                        <span>联系电话</span>
                        <input type="text"  name="link_phone" id="contact_phone"  placeholder="请填写联系人电话" value="<?php echo $a_view_data['orderinfo']['link_phone']; ?>"   onkeyup="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li class="contactCode">
                    	<em><input value="获取验证码"  type="button" id="codeBtn" class=" removeBtn"></em>
                        <input  type="text" name="code" value="<?php echo $a_view_data['orderinfo']['code']; ?>" placeholder="验证码" id="contact_code"  onkeyup="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                </ul>
            </div>
            <!-- 联系人 -->
            ...
            <div class="payWay">
                <input type="hidden" name="typenum" value="<?php echo $_SESSION['appointment_type']; ?>">
...
$(function(){
    ...
    var typenum = "<?php echo $_SESSION['appointment_type']; ?>";
    if (typenum == 2) {
        var office_seat = $("input[name='office_seat']").val();
        if (office_seat != '') {
            var office_seat_arr = office_seat.split(',');
            var se_lenght = office_seat_arr.length;
            var per = "<?php echo $a_view_data['office']['office_price']; ?>";
            var actual_pay = per*se_lenght;
