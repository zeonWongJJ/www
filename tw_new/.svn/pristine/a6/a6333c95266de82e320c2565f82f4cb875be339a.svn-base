...
//import com.qidu.chat.push.gcm.GCMIntentService;
...
public class BackgroundActionButtonHandler extends BroadcastReceiver implements PushConstants {
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    notificationManager.cancel(/*GCMIntentService.getAppName(context)*/"org.wfky.app", notId);
