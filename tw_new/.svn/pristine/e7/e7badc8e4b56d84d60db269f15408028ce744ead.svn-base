    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($connection, $config = [])
    {
        ...
        $this->config = array_merge([
            'client_table'        => $this->db->get_prefix() . 'oauth_clients',
            'access_token_table'  => $this->db->get_prefix() . 'oauth_access_tokens',
            'refresh_token_table' => $this->db->get_prefix() . 'oauth_refresh_tokens',
            'code_table'          => $this->db->get_prefix() . 'oauth_authorization_codes',
            'user_table'          => $this->db->get_prefix() . 'oauth_users',
            'jwt_table'           => $this->db->get_prefix() . 'oauth_jwt',
            'jti_table'           => $this->db->get_prefix() . 'oauth_jti',
            'scope_table'         => $this->db->get_prefix() . 'oauth_scopes',
            'public_key_table'    => $this->db->get_prefix() . 'oauth_public_keys',
        ], $config);
    }
