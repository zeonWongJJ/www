<?php
// 0571-88158090 支付宝技术联系链接，点我要在线咨询，遇机器人打“我要人工”或者“人工服务”或者“人工链接”，输入三次之后会出现人工链接：https://support.open.alipay.com/alipay/support/index.htm
// https://doc.open.alipay.com/docs/doc.htm?spm=a219a.7629140.0.0.Cnbsvf&treeId=58&articleId=103578&docType=1

// 加载接口入口文件
require_once(BASEPATH . '/libraries/pay/alipay_pc/AopSdk.php');
...
class TW_alipay_pc {
	...
	private $_s_config_file = 'config_alipay';
	...
	*/
	...
	public function pay($a_param = []) {
		...
		$o_request = new AlipayTradePagePayRequest();
