							...
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="pot">
										<form action="latest_user-<?php echo isset($_POST['id']) ? $_POST['id'] : '';?>-<?php echo isset($_POST['name']) ? $_POST['name'] : '';?>-<?php echo isset($_POST['tesname']) ? $_POST['tesname'] : '';?>-<?php echo isset($_POST['email']) ? $_POST['email'] : '';?>-<?php echo isset($_POST['mobile']) ? $_POST['mobile'] : '';?>-" method="post">
