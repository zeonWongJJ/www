...
import com.gzqx.common.adapter.ActionSheetDialogAdapter;
	...
	public ActionSheetDialog setSheetItems(List<ActionItem> itemList) {
		...
		if (size >= 6) {
			LayoutParams params = (LayoutParams) recyclerView
					.getLayoutParams();
			params.height = (display.getHeight() - ScreenUtils.getStatusBarHeight(context) - ScreenUtils.dip2px(context, 50)) / 2;
