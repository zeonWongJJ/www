...
/**********************************************************************************/
    ...
    public function user_index() {
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            //获取竞标中的订单总数
            $inbid_total = $this->user_model->get_demand_total(11);
            //获取待付款的订单数量
            $waitpay_total = $this->user_model->get_demand_total(12);
            //获取待确定的订单数量
            $waitconfirm_total = $this->user_model->get_demand_total(13);
            //获取待服务的订单
            $waitservice_total = $this->user_model->get_demand_total(14);
            //获取服务中的订单
            $inservice_total = $this->user_model->get_demand_total(15);
            //获取待评价的订单
            $waitcomment_total = $this->user_model->get_demand_total(16);
            //获取已完成的订单
            $complete_total = $this->user_model->get_demand_total(17);
            $a_data = [
