				...
				<div class="li_div" @click="plan_details(item,index)">
					<div>
						<div class="plantype">
							...
							<!--<img v-if="item.plan_type == 1 && item.thisWeek" src="../../assets/img/week.png" />
						...
						<div class="btnBox">
							<div style="display: flex;">
								...
								<div v-else class="score btn" @click.stop="doScore = true,oplan_score(item,index)">评分</div>
								<div class="edit btn" @click.stop="bianji(item,index)">编辑</div>
