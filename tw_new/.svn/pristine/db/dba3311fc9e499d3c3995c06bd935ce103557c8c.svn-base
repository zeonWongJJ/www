...
public class PanelView extends LinearLayout
{
    ...
    public PanelView(Context context, AttributeSet attrs)
    {
        ...
        mDuration = a.getInteger(R.styleable.PanelView_animationDuration, 750);     // duration defaults to 750 ms
        mPosition = a.getInteger(R.styleable.PanelView_position, BOTTOM);           // position defaults to BOTTOM
        mLinearFlying = a.getBoolean(R.styleable.PanelView_linearFlying, false);    // linearFlying defaults to false
        mWeight = a.getFraction(R.styleable.PanelView_weight, 0, 1, 0.0f);          // weight defaults to 0.0
        ...
        mOpenedHandle = a.getDrawable(R.styleable.PanelView_openedHandle);
        mClosedHandle = a.getDrawable(R.styleable.PanelView_closedHandle);

        RuntimeException e = null;
        mHandleId = a.getResourceId(R.styleable.PanelView_handle, 0);
        if (mHandleId == 0)
        {
        ...
        mContentId = a.getResourceId(R.styleable.PanelView_content, 0);
        if (mContentId == 0)
        {
            e = new IllegalArgumentException(
                    a.getPositionDescription()
    ...
    private OnDownListener animListener;
    public void setOnDownListener(OnDownListener animListener){
