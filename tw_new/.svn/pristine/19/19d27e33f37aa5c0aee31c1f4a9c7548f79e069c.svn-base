...
<html>
    ...
    <!-- 拉框结束 -->
		<div class="main">
			<header class="head"><a href="user_update"><img src="static/style_default/images/kefu_03.png"/></a><i>设置支付密码</i></header>
			<div class="fillBox">
				<form id="paymentform" action="user_payment" method="post">
				<ul>
					<li class="phone">
					...
					<li class="password">
						<input type="password" name="payment_code" class="int" placeholder="支付密码" />
					...
					<li class="password">
						<input type="password" name="payment_code2" class="int" placeholder="再次输入支付密码" />
						<i class="openEye"><img src="static/style_default/images/huiyan_03.png"/></i>
						<i class="closeEye"><img src="static/style_default/images/huiyan_06.png"/></i>
					</li>
				</ul>
