...
<head lang="en">
    ...
    <script src="./static/style_default/script/updateDevice.js"></script>
    <title>添加设备</title>
</head>
...
<div class="productClassification">
    ...
    <article>
        ...
        <!-- 添加设备 -->
        <div class="addDevice">
            <p><a href="room_showlist" style="color:#000;">房间管理</a> > <a href="device_showlist" style="color:#000;">设备列表</a> > 修改设备</p>
        ...
        <div class="deviceList">
            <form action="device_update" method="post">
                <input type="hidden" id="record_id" name="device_id" value="<?php echo $a_view_data['detail']['device_id']; ?>">
                <ul>
                    <li class="deviceName">
                        <em><s>*</s>设备名称</em>
                        <input type="text" id="device_name" name="device_name" value="<?php echo $a_view_data['detail']['device_name']; ?>"/>
                        <span class="hide">
                    ...
                    <li class="deviceNum">
                        <em><s>*</s>设备型号</em>
                        <input type="text" id="device_num" name="device_version" value="<?php echo $a_view_data['detail']['device_name']; ?>"/>
                         <span class="hide">
                            <img src="./static/style_default/image/t_03.png" />
                            <em></em>
                        </span>
                    </li>
                    <input type="hidden" name="device_state" value="<?php echo $a_view_data['detail']['device_state']; ?>">
                    <li class="deviceDisplay">
                        <em><s>*</s>是否开放</em>
                        <em class="sure" style="width:50px; text-align:left;" value='1'>
                            <?php if ($a_view_data['detail']['device_state'] == 1) {
                        ...
                        <em  class="deny" style="width:50px; text-align:left;" value='0'>
                            <?php if ($a_view_data['detail']['device_state'] == 0) {
                                echo '<img src="./static/style_default/image/pro_36.png" />';
                            } else {
                                echo '<img  src="./static/style_default/image/pro_38.png" />';
                            } ?>
                    ...
                    <li class="mainFigure">
                        ...
                        <div class="figureContent">
                            ...
                            <input type="hidden" name="mainpic_path" value="<?php echo $a_view_data['detail']['device_mainpic']; ?>">
                            <input type="hidden" name="otherpic_path" value="<?php echo $a_view_data['detail']['device_otherpic']; ?>">
...
最多支持10张图片，将按上传顺序展示图片，支持批量上传。</span>
                    ...
                    <li class="deviceDescribe">
                        <em>设备描述</em>
                        <textarea name="device_description" id="describe" cols="30" rows="10"><?php echo $a_view_data['detail']['device_description']; ?></textarea>
                    </li>
                </ul>
