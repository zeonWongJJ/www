...
<div class="productClassification">
    ...
    <article>
        ...
        <div class="releaseNews">
            <p><a href="news_showlist" style="color:#000;">新闻管理</a> >修改新闻</p>
        ...
        <div class="NewsList">
            <form id="addform" action="<?php echo $this->router->url('news_update'); ?>" method="post">
                <input type="hidden" name="news_id" value="<?php echo $a_view_data['news']['news_id']; ?>">
                <input type="hidden" name="original_cate" value="<?php echo $a_view_data['news']['cate_id']; ?>">
                <ul>
                    <li class="category">
                        <span>所属分类</span>
                    ...
                    <li class="NewsTitle">
                        <span>新闻标题</span>
                        <input type="text" size="80" id="NewsTitle_name" name="news_title" value="<?php echo $a_view_data['news']['news_title']; ?>" />
                        <em class="hide">
                    ...
                    <li class="editBox" style="overflow:hidden;">
                        ...
                        <script id="editor" style="width:90%; height:300px; float:left;" name="news_content" type="text/plain"><?php echo $a_view_data['news']['news_content']; ?></script>
                    </li>
                </ul>
            </form>
            <span id="NewsSub">确定修改</span>
        </div>
        <!-- 发布公告 -->
