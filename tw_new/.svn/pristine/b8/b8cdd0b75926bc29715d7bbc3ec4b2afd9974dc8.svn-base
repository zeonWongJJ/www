	...
	<div class="staff">
		...
		<div class="body" v-if="!more">
			...
			<div class="row">
				<div class="item">
					<div class="img">
						<img :src="uploadFileUrl + staff_data.staff_id_card_pic_zm"/>
					</div>
					<div>身份证正面照</div>
				</div>
				<div class="item">
					<div class="img">
						<img :src="uploadFileUrl + staff_data.staff_id_card_pic_bm"/>
					</div>
					<div>身份证反面照</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="item">
					<div class="img">
            			<img v-if="staff_data.store_zizhi_opposite" :src="uploadFileUrl + staff_data.staff_cert_pic_zm"/>
					</div>
					<div>资质证书正面照</div>
				</div>
				<div class="item">
					<div class="img">
            			<img v-if="staff_data.store_zizhi_positive" :src="uploadFileUrl + staff_data.staff_cert_pic_bm"/>
					</div>
					<div>资质证书反面照</div>
				</div>
			</div>
