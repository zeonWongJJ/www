                    ...
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (mOnTagSelectListener != null) {
                                mOnTagSelectListener.onItemSelect(FlowTagLayout.this, new ArrayList<UserRealm>());
                            }
                            return;
                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this, Arrays.asList((UserRealm) mAdapter.getItem(j)));
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
                        ...
                        //回调
                        if (mOnTagSelectListener != null) {
                            List<UserRealm> list = new ArrayList<UserRealm>();
                            for (int k = 0; k < mAdapter.getCount(); k++) {
                                if (mCheckedTagArray.get(k)) {
                                    list.add((UserRealm) mAdapter.getItem(k));
                                }
                            }
