...
public class TaskInPlanListAdapter extends CommonAdapter<Task> {
    private AbsBaseActivity activity;
    private String plan_sub_id;
    public TaskInPlanListAdapter(AbsBaseActivity activity,String plan_sub_id) {
        super(activity, R.layout.layout_task_item_in_plan_details);
        this.activity=activity;
        this.plan_sub_id=plan_sub_id;
    }
