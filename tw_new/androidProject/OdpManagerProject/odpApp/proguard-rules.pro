...
-libraryjars ../baseAppcommonLib/libs/libammsdk.jar
#三星应用市场需要添加:sdk-v1.0.0.jar,look-v1.0.1.jar
#-libraryjars libs/sdk-v1.0.0.jar
#-libraryjars libs/look-v1.0.1.jar

#项目中的activity、constants、model、bean等混淆配置
-keep class app.odp.qidu.plugin.** {*;}
-keep class app.odp.qidu.bean.** { *; }
-keep class com.common.lib.bean.** {*;}
-keep class com.app.base.bean.** {*;}
-keep class com.app.base.treeview.model.** {*;}
#文件选择
-keep class choose.lm.com.fileselector.model.** {*;}
