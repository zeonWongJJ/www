...
public class PhotoFragment extends BaseFileFragment{
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        rcPhoto=mFragmentRootView.findViewById(R.id.rc_photo);
        ...
        rcPhoto.setLayoutManager(manager);
        rcPhoto.setAdapter(mGroupAdapter);
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        if(getActivity()!=null){
                            ...
                            loadFiles.loadImages(getActivity().getContentResolver());
