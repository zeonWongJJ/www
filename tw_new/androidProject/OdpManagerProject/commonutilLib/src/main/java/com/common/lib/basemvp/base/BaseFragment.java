package com.common.lib.basemvp.base;
...
import com.common.lib.basemvp.view.IBaseFragmentView;
...
//                R.anim.translate_fade_out_right, R.anim.translate_fade_in_left, R.anim.translate_fade_out_left);
    ...
    @Override
    public void showError(Throwable throwable, boolean show) {
        if(throwable instanceof ANError){
            //ANError anError= (ANError) throwable;
            if(show){
                ToastUtils.show("数据加载失败，可能网络异常");
            }
