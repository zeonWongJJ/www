...
public abstract class BaseListAndGridAdapter<T> extends BaseAdapter implements AbsListView.OnScrollListener {
    ...
    public BaseListAndGridAdapter(AbsListView view, Collection<T> mDatas, int itemLayoutId) {
