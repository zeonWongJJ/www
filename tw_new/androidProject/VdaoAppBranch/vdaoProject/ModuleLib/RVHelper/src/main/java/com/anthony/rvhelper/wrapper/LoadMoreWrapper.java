...
import com.anthony.rvhelper.LoadMoreScrollListener;
...
public class LoadMoreWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    private boolean isCompleteStates=false;
    ...
    public LoadMoreWrapper(Context context, RecyclerView.Adapter adapter) {
        ...
        mLoadMoreScrollListener = new LoadMoreScrollListener() {
            ...
            public void loadMore() {
                if (mOnLoadListener != null && isHaveStatesView && !isCompleteStates) {
                    if (!isLoadError) {
                        showLoadMore();
    ...
    public LoadMoreWrapper setOnLoadMoreListener(OnLoadMoreListener onLoadListener) {
