...
public class PluginAction {
    ...
    public static final String ACTION_TITLE_BAR_LAYOUT_IS_VISIBLE = "titleBarLayoutIsVisible";//openNewWindow
    public static final String ACTION_IS_ARROW_WINDOW_FINISH = "isArrowWindowFinish";//openNewWindow
    ...
    public static final String ACTION_INIT_SYSTEM_PARAMS = "initSystemParams";
