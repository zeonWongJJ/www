package com.qidu.chat.fragment.chatroom.list
...
import com.qidu.chat.helper.EndlessRecyclerViewScrollListener
import com.qidu.chat.layouthelper.chatroom.list.RoomFileListAdapter
import com.qidu.chat.layouthelper.chatroom.list.RoomMemberListAdapter
import com.qidu.chat.layouthelper.chatroom.list.RoomMessagesAdapter
...
class RoomListFragment : Fragment(), RoomListContract.View {
    ...
    override fun showPinnedMessages(dataSet: ArrayList<Message>, total: String) {
        ...
        if (recyclerView.adapter == null) {
            recyclerView.adapter = RoomMessagesAdapter(dataSet, hostname, activity)
