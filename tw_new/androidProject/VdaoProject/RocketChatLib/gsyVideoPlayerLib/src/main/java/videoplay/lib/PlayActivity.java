...
import videoplay.lib.listener.OnTransitionListener;
import videoplay.lib.video.SampleVideo;
...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Log.i("bbbb",video_path);
        if(video_path==null){
            finish();
        }
        HttpProxyCacheServer.Builder d=new HttpProxyCacheServer.Builder(this);
        File sd= Environment.getExternalStorageDirectory();
        String path=sd.getPath()+"/PictureSelector/CameraImage";
        File file=new File(path);
        if(!file.exists()){
            file.mkdir();
        }
        d.cacheDirectory(file);//自定义缓存目录
