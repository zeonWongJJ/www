...
public class CardScaleHelper {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    /*if(tempPos!=mCurrentItemPos){//此处要加个recyclerview停止滑动的判断
                        if(listener!=null){
                            listener.smoothScrollToCurrentPosition(getCurrentItemPos());
                        }
                    }*/
                } else {
    ...
    /*public interface OnSmoothScrollToPositionListener{
        void smoothScrollToCurrentPosition(int position);
    }
    private OnSmoothScrollToPositionListener listener;
    public void setOnSmoothScrollToPositionListener(OnSmoothScrollToPositionListener listener){
    ...
    private void computeCurrentItemPos() {
        ...
        //Log.i("aaaaa","mCurrentItemPos====="+mCurrentItemPos);
    }
