...
/**
 * 圆形进度条
 * https://blog.csdn.net/yung7086/article/details/50241973
...
public class CircleProgress extends View {
    ...
    private int socktwidth = dp2px(4);// 圆环进度条的宽度
    private Paint paint = new Paint();
    private Rect rec = new Rect();
    private int value = 0;// 百分比0~100;
    private int textSize = dp2px(12);// 文字大小
    private Bitmap bitmap;
    @Deprecated
    float scale = 0.15f;// 中间背景图片相对圆环的大小的比例
    private int preColor = Color.parseColor("#f1f2f7");// 进度条未完成的颜色
    private int progressColor = Color.parseColor("#ffd75d");// 进度条颜色
