...
import com.printer.receipt.utils.PrintLabel100;
import com.printer.receipt.utils.PrintLabel58;
import com.printer.receipt.utils.PrintLabel80;
import com.printer.receipt.utils.PrintLabelDrink;
import com.printer.receipt.utils.PrintLabelExpress;
import com.printer.receipt.utils.PrintLabelFruit;
import com.printer.receipt.utils.PrintLabelMaterial;
import com.printer.receipt.utils.PrintLabelStorage;
import com.printer.receipt.utils.PrintLablel;
...
public class LablePrintActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (CashRegisterApplication.isSettingTSPL) {
	...
	@Override
	public void onClick(View v) {
		if (mPritner == null && !CashHomeActivity.isConnected) {
